...
//         $.ajax({
//             type : 'POST',
//             url  : 'modules/login/controller/controller_login.php?&op=time',
...
//         $.ajax({
//             type : 'POST',
//             url  : 'modules/login/controller/controller_login.php?op=regenid',
//             success: function(response){
//             }
//         });
//      }, 100000);
...
//         $.ajax({
//             type : 'POST',
//             url  : 'modules/login/controller/controller_login.php?&op=gravatar',
...
//         $.ajax({
//             type : 'GET',
//             url  : 'modules/like/controller/controller_like.php?&op=ins_like&id=' + id,
//             success: function(data){		
//                 var json = JSON.parse(data);
//                 console.log(json);
//                 // var Elementli = document.createElement('li');
