...
class profileDAO {
    ...
    public function obtain_provinces_DAO(){
        ...
        $provincias = simplexml_load_file($_SERVER['DOCUMENT_ROOT'].'/www/FW_PHP_OO_MVC_JQUERY/Andiamo/resources/provinciasypoblaciones.xml');
    ...
    public function obtain_cities_DAO($arrArgument){
        ...
        $xml = simplexml_load_file($_SERVER['DOCUMENT_ROOT'].'/www/FW_PHP_OO_MVC_JQUERY/Andiamo/resources/provinciasypoblaciones.xml');
